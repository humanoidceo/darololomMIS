        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="home-hero-copy wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="home-hero-highlights">
                    <span>آرشیف عمومی مقالات</span>
                    <span>معرفی ساختار و فعالیت‌ها</span>
                    <span>ارتباط مستقیم با دارالعلوم</span>
                </div>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="home-impact-card">
                <strong>معرفی حرفه‌ای</strong>
                <span>صفحه‌ی خانه با چیدمان بازتر و حرفه‌ای‌تر، هویت دارالعلوم را بهتر نمایش می‌دهد.</span>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="home-impact-card">
                <strong>دسترسی عمومی</strong>
                <span>بخش مقالات برای مطالعه و دانلود عمومی در دسترس قرار دارد و مخاطب به‌سادگی به آن می‌رسد.</span>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="home-impact-card">
                <strong>ارتباط روشن</strong>
                <span>لینک‌ها و سکشن‌های اصلی وبسایت با ساختاری روشن به بخش‌های مهم متصل شده‌اند.</span>
            </div>
        </div>
    </div>
</section>
...
<section class="home-links-section">
    <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
        <h2>دسترسی به بخش‌های مهم</h2>
        <p class="home-section-lead">مهم‌ترین مسیرهای وبسایت در این بخش به شکل واضح و حرفه‌ای در اختیار شما قرار گرفته است.</p>
    </div>
...
<section class="home-gallery-section">
    <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
        ...
        <p class="home-section-lead">بخشی از فضا، فعالیت‌های آموزشی و هماهنگی کادر دارالعلوم را در این گالری مشاهده می‌کنید.</p>
    </div>
